...
- (void)updateButtonLayout {
    [AutoLayout offset:0.0 forThisItemTop:self.browseButton toThatItemBottom:self.topLayoutGuide];
    ...
    [AutoLayout offset:0.0 forThisItemTop:self.bookButton toThatItemBottom:self.browseButton];
    ...
    [AutoLayout offset:0.0 forThisItemTop: self.lookupButton toThatItemBottom:self.bookButton];
