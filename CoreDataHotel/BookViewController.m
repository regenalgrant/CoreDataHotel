...
-(void)guestInfo {
    ...
    NSLayoutConstraint *top = [AutoLayout genericContraintFrom:self.firstName toView:self.view withAttribute: NSLayoutAttributeTop];
    
    top.constant = navAndStatusBarHeight + 20;
    
    NSLayoutConstraint *leading = [AutoLayout leadingConstraintFrom:self.firstName toView:self.view];
    
    leading.constant = 20;
    
    NSLayoutConstraint *trailing = [AutoLayout trailingConstraintFrom:self.firstName toView:self.view];
...
-(void)setNameField {
    ...
    NSLayoutConstraint *top = [AutoLayout genericContraintFrom:self.nameField toView:self.view withAttribute: NSLayoutAttributeTop];
    
    top.constant = navAndStatusBarHeight + 20;
    
    NSLayoutConstraint *leading = [AutoLayout leadingConstraintFrom:self.nameField toView:self.view];
    
    leading.constant = 20;
    
    NSLayoutConstraint *trailing = [AutoLayout trailingConstraintFrom:self.nameField toView:self.view];
