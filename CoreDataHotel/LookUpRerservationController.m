...
@property(strong, nonatomic)UITableViewCell *reservation;
...
- (void)setupSearchBar {
    ...
    [AutoLayout offset:0 forThisItemTop:self.searchBar toThatItemBottom:self.topLayoutGuide];
...
- (void)setupTableView
{
    ...
    [self.tableView registerClass:[Reservation class] forCellReuseIdentifier:@"cell"];
    ...
    [AutoLayout offset:0 forThisItemTop:self.tableView toThatItemBottom:self.searchBar];
}
